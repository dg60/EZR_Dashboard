...
angular.module('myApp.charts_Valentin', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_Valentin', {
    templateUrl: 'pages/charts_Valentin/charts_Valentin.html',
    controller: 'chartsCtrl_Valentin'
  });
}])

  .controller('chartsCtrl_Valentin', function() {

})

  .controller('Ctrl_Valentin', function($scope,$http) {
// Init Timepicker===============================================================
