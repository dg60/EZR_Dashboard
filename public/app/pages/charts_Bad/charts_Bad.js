...
angular.module('myApp.charts_Bad', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_Bad', {
    templateUrl: 'pages/charts_Bad/charts_Bad.html',
    controller: 'chartsCtrl_Bad'
  });
}])

  .controller('chartsCtrl_Bad', function() {

})

  .controller('Ctrl_Bad', function($scope,$http) {
// Init Timepicker===============================================================
