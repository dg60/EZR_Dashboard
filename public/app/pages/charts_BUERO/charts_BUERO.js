...
angular.module('myApp.charts_BUERO', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_BUERO', {
    templateUrl: 'pages/charts_BUERO/charts_BUERO.html',
    controller: 'chartsCtrl_BUERO'
  });
}])

  .controller('chartsCtrl_BUERO', function() {

})

  .controller('Ctrl_BUERO', function($scope,$http) {
// Init Timepicker===============================================================
