...
angular.module('myApp.charts_SZ', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_SZ', {
    templateUrl: 'pages/charts_SZ/charts_SZ.html',
    controller: 'chartsCtrl_SZ'
  });
}])

  .controller('chartsCtrl_SZ', function() {

})

  .controller('Ctrl_SZ', function($scope,$http) {
// Init Timepicker===============================================================
