...
angular.module('myApp.charts_Niklas', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_Niklas', {
    templateUrl: 'pages/charts_Niklas/charts_Niklas.html',
    controller: 'chartsCtrl_Niklas'
  });
}])

  .controller('chartsCtrl_Niklas', function() {

})

  .controller('Ctrl_Niklas', function($scope,$http) {
// Init Timepicker===============================================================
