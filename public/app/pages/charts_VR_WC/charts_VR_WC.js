...
angular.module('myApp.charts_VR_WC', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_VR_WC', {
    templateUrl: 'pages/charts_VR_WC/charts_VR_WC.html',
    controller: 'chartsCtrl_VR_WC'
  });
}])

  .controller('chartsCtrl_VR_WC', function() {

})

  .controller('Ctrl_VR_WC', function($scope,$http) {
// Init Timepicker===============================================================
