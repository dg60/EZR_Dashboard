...
angular.module('myApp.charts_WZ', ['ngRoute'])

.config(['$routeProvider', function($routeProvider) {
  $routeProvider.when('/charts_WZ', {
    templateUrl: 'pages/charts_WZ/charts_WZ.html',
    controller: 'chartsCtrl_WZ'
  });
}])

  .controller('chartsCtrl_WZ', function() {

})

  .controller('Ctrl_WZ', function($scope,$http) {
// Init Timepicker===============================================================
